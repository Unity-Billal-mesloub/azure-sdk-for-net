...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class BatchVmDataDisk
    {
        ...
        internal BatchVmDataDisk(int lun, BatchDiskCachingType? caching, int diskSizeInGB, BatchStorageAccountType? storageAccountType, ManagedDisk managedDisk, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Lun = lun;
            Caching = caching;
            DiskSizeInGB = diskSizeInGB;
