...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class HostEndpointSettings
    {
        ...
        internal HostEndpointSettings(HostEndpointSettingsModeTypes? mode, string inVMAccessControlProfileReferenceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Mode = mode;
