...
namespace Azure.ResourceManager.Batch.Models
{
    ...
    public partial class DiskCustomerManagedKey
    {
        ...
        internal DiskCustomerManagedKey(string keyUri, bool? rotationToLatestKeyVersionEnabled, PoolIdentityReference identityReference, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            KeyUri = keyUri;
        ...
        public string IdentityReferenceResourceId
        {
            ...
            set
            {
                IdentityReference = new PoolIdentityReference(value);
            }
        }
    }
}
