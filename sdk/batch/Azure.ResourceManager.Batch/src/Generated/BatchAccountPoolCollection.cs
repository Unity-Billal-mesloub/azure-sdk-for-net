...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class BatchAccountPoolCollection : ArmCollection, IEnumerable<BatchAccountPoolResource>, IAsyncEnumerable<BatchAccountPoolResource>
    {
        ...
        internal BatchAccountPoolCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _poolRestClient = new Pool(_poolClientDiagnostics, Pipeline, Endpoint, batchAccountPoolApiVersion ?? "2025-06-01");
        ...
        /// <param name="batchAccountPoolData"> Additional parameters for pool creation. </param>
        /// <param name="matchConditions"> The content to send as the request conditions of the request. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="poolName"/> or <paramref name="batchAccountPoolData"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="poolName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<ArmOperation<BatchAccountPoolResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string poolName, BatchAccountPoolData batchAccountPoolData, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(poolName, nameof(poolName));
            Argument.AssertNotNull(batchAccountPoolData, nameof(batchAccountPoolData));
            ...
            try
            {
                ...
                HttpMessage message = _poolRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, poolName, BatchAccountPoolData.ToRequestContent(batchAccountPoolData), matchConditions, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="poolName"/> or <paramref name="batchAccountPoolData"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="poolName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<BatchAccountPoolResource> CreateOrUpdate(WaitUntil waitUntil, string poolName, BatchAccountPoolData batchAccountPoolData, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(poolName, nameof(poolName));
            Argument.AssertNotNull(batchAccountPoolData, nameof(batchAccountPoolData));
