...
namespace Azure.ResourceManager.Batch
{
    ...
    public partial class BatchApplicationCollection : ArmCollection, IEnumerable<BatchApplicationResource>, IAsyncEnumerable<BatchApplicationResource>
    {
        ...
        public virtual async Task<ArmOperation<BatchApplicationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string applicationName, BatchApplicationData batchApplicationData = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _applicationRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, applicationName, BatchApplicationData.ToRequestContent(batchApplicationData), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="applicationName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="applicationName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<BatchApplicationResource> CreateOrUpdate(WaitUntil waitUntil, string applicationName, BatchApplicationData batchApplicationData = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(applicationName, nameof(applicationName));
